...
def get_args():
    ...
    parse.add_argument('--nb-epochs', type=int, default=1000, help='the epochs to train the network')
    ...
    parse.add_argument('--display-interval', type=int, default=1, help='interval to display')
    # ddpg not support gpu
    parse.add_argument('--cuda', action='store_true', help='if use GPU')
    parse.add_argument('--alg', type=str, default='ddpg', help='the algorithm')
    parse.add_argument('--dist', type=str, default='pg', help='the distributions for sampling actions')
