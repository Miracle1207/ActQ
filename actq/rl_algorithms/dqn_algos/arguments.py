...
def get_args():
    ...
    parse.add_argument('--hidden-size', type=int, default=128, help='number of hidden cells')
    ...
    parse.add_argument('--dist',  type=str, default='actq', help='actq or uniform')
    parse.add_argument('--alg', type=str, default='dqn', help='the algorithm')
    parse.add_argument('--k', type=int, default=5, help='the number of discrete actions')
    parse.add_argument('--num-updates', type=int, default=500, help='the number of discrete actions')
